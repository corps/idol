...
ListOfTestKind.metadata = {"dependencies":[{"from":{"module_name":"all.required","qualified_name":"all.required.ListOfTestKind","type_name":"ListOfTestKind"},"is_abstraction":false,"is_local":false,"to":{"module_name":"tests.basic","qualified_name":"tests.basic.TestKind","type_name":"TestKind"}}],"fields":{},"is_a":{"literal":null,"parameters":[],"primitive_type":"int","reference":{"module_name":"tests.basic","qualified_name":"tests.basic.TestKind","type_name":"TestKind"},"struct_kind":"Repeated"},"named":{"module_name":"all.required","qualified_name":"all.required.ListOfTestKind","type_name":"ListOfTestKind"},"options":[],"tags":["atleast_one"],"type_vars":[]};
