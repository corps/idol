...
import { testsBasicTestKindType } from "./TestKind.js";
import { GraphQLList as GraphQLList_ } from "graphql";

export const testsBasicTestAtleastOneType = new GraphQLList_(
  testsBasicTestKindType
);
