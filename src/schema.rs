    ...
    pub fn literal_value(&self) -> serde_json::Value {
        ...
        (self.literal.to_owned()).map_or(serde_json::Value::Null, |literal| {
            match primitive_type {
                ...
                PrimitiveType::bool => serde_json::Value::from(literal.literal_bool),
                PrimitiveType::int64 => serde_json::Value::from(literal.literal_int64),
                PrimitiveType::int53 => serde_json::Value::from(literal.literal_int53.0),
                PrimitiveType::double => serde_json::Value::from(literal.literal_double),
                PrimitiveType::string => serde_json::Value::from(literal.literal_string.to_owned()),
            }
        })
    }
