from idol.__idol__ import Struct as _Struct, List as _List, Map as _Map, Optional as _Optional, \
    Enum as _Enum, Any as _Any, Literal as _Literal, expand_primitive as _expand_primitive, \
...
class StructKind(_Enum):
    ...
    __metadata__ = json.loads(
        '{"dependencies": [], "fields": {}, "is_a": null, "named": {"module_name": "schema", "qualified_name": "schema.StructKind", "type_name": "StructKind"}, "options": ["Scalar", "Repeated", "Map"], "tags": [], "type_vars": []}')
...
class PrimitiveType(_Enum):
    ...
    # but the json.dumps is stable.
    __metadata__ = json.loads(
        '{"dependencies": [], "fields": {}, "is_a": null, "named": {"module_name": "schema", "qualified_name": "schema.PrimitiveType", "type_name": "PrimitiveType"}, "options": ["int", "double", "string", "bool", "any"], "tags": [], "type_vars": []}')
