  ...
  _createClass(IdolGraphqlQueries, [{
    ...
    value: function codegenFile(ref) {
      ...
      return (0, _functional.cachedProperty)(this, "codegenFile".concat(path.path), function () {
        return new _this.IdolGraphqlQueriesCodegenFile(_this, path, type);
      });
    }
  }, {
    key: "scaffoldFile",
    value: function scaffoldFile(ref) {
      ...
      return (0, _functional.cachedProperty)(this, "scaffoldFile".concat(path.path), function () {
        return new _this2.IdolGraphqlQueriesScaffoldFile(_this2, path, type);
      });
    }
  }, {
    key: "render",
    ...
    key: "IdolGraphqlQueriesCodegenFile",
    get: function get() {
      return IdolGraphqlQueriesCodegenFile;
    }
  }, {
    key: "IdolGraphqlQueriesScaffoldFile",
    get: function get() {
...
function (_GeneratorFileContext) {
  ...
  _createClass(IdolGraphqlQueriesCodegenFile, [{
    ...
    value: function struct(inputVariant) {
      ...
      return (0, _functional.cachedProperty)(this, "struct".concat(inputVariant.toString()), function () {
        return _this5.graphqlCodegenFile(inputVariant).struct.map(function (struct) {
          return new _this5.IdolGraphqlQueriesCodegenStruct(_this5, struct.fields.map(function (field) {
            return new _this5.IdolGraphQLQueriesCodegenTypeStruct(_this5.parent, field);
          }));
        });
      });
    }
    ...
    key: "IdolGraphqlQueriesCodegenStruct",
    get: function get() {
      return IdolGraphqlQueriesCodegenStruct;
    }
  }, {
    key: "IdolGraphQLQueriesCodegenTypeStruct",
    get: function get() {
    ...
    get: function get() {
      ...
      return (0, _functional.cachedProperty)(this, "typeStruct", function () {
        return _this7.graphqlCodegenFile(false).typeStruct.map(function (ts) {
          return new _this7.IdolGraphqlQueriesCodegenTypeStructDeclaration(_this7, ts);
        });
      });
    }
  }, {
    key: "IdolGraphqlQueriesCodegenTypeStructDeclaration",
    get: function get() {
    ...
    get: function get() {
      ...
      return (0, _functional.cachedProperty)(this, "service", function () {
        return _this9.typeDecon.getStruct().filter(function (_) {
          ...
          return new _this9.IdolGraphqlQueriesService(_this9, fields);
        });
      });
    }
  }, {
    key: "IdolGraphqlQueriesService",
    get: function get() {
    ...
    get: function get() {
      ...
      return (0, _functional.cachedProperty)(this, "innerScalar", function () {
        return _this13.tsDecon.getScalar().concat(_this13.tsDecon.getRepeated()).map(function (scalarDecon) {
          return new _this13.IdolGraphqlCodegenScalar(_this13.idolGraphqlQueries, scalarDecon);
        });
      }).concat(this.tsDecon.getMap().map(function (map) {
        return new _this13.IdolGraphqlCodegenScalar(_this13.idolGraphqlQueries, new _this13.ScalarDeconstructor(new _TypeStruct.TypeStruct(_TypeStruct.TypeStruct.expand({
...
function (_GeneratorFileContext4) {
  ...
  _createClass(IdolGraphqlQueriesService, [{
    ...
    value: function methodFor(tDecon, serviceFieldName, fieldTags) {
      return new this.IdolGraphqlMethod(this.scaffoldFile, tDecon, this.codegenFile.type.named.typeName, serviceFieldName, (0, _generators.includesTag)(fieldTags, "mutation"));
    }
  }, {
    key: "declaredFragments",
    get: function get() {
