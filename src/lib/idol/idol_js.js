...
function () {
  ...
  _createClass(ModuleBuildEnv, [{
    ...
    value: function writeModule(module) {
      var moduleFilePath = _path["default"].join(this.buildEnv.buildDir, ModuleBuildEnv.modulePathOf(module.moduleName));
                ...
                return regeneratorRuntime.wrap(function _callee4$(_context7) {
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        _context7.next = 2;
                        return "return ".concat(type.named.typeName, ".wrap.apply(").concat(type.named.typeName, ", arguments);");
    ...
    key: "modulePathOf",
    value: function modulePathOf(moduleName) {
      return moduleName.split(".").join("/") + ".js";
    }
  }]);
